...
contract MyEpicNFT is ERC721URIStorage{
    ...
    // This is our SVG code. All we need to change is the word, color that's displayed. Everything else stays the same.
    ...
    function makeEpicNFT() public {
        ...
        string memory randomColor = pickRandomColor(newId);
